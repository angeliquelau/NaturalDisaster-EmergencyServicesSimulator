...
//     private static final long DURATION = 1000;
    ...
    private static final long DURATION = 145;
    ...
    public ResponderCommImpl()
    {
        ...
        //arriving = true means responders arrived
        //arriving = false means responders have left the location
...
//         events.add(new REvent(55, "fire", false, "Midtown"));     
        ...
        /*--------------------------------------------
        starting from here is for the input data
        --------------------------------------------*/
        // events.add(new REvent(9, "flood", true, "Time Square")); //test for invalid messages
        events.add(new REvent(9, "flood", true, "Midtown"));
        events.add(new REvent(16, "flood", false, "Midtown"));
        events.add(new REvent(43, "fire", true, "Hill Valley"));
        events.add(new REvent(52, "fire", false, "Hill Valley"));
        events.add(new REvent(74, "chemical", true, "Westtown"));
        events.add(new REvent(104, "chemical", false, "Westtown"));
        events.add(new REvent(108, "flood", true, "Hill Valley"));
        events.add(new REvent(128, "flood", false, "Hill Valley"));
        events.add(new REvent(131, "fire", true, "Midtown"));
        events.add(new REvent(141, "fire", false, "Midtown"));
        // ...
    }
